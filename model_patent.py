...
def create_generator(generator_inputs, generator_outputs_channels,name="generator_1", reuse=False):
#    U_Net结构
...
#    with tf.variable_scope("sar2opt"):
        ...
        g_outputs = create_generator(inputs_s, out_channels)  # fake_optical
